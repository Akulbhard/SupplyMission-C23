...
function setup() {
	...
	box2 = createSprite(500,600,20,200);
	box3 = createSprite(300,600,20,200);
	...
	box2 = Bodies.rectangle(500, 600, 20, 200 , {isStatic:true} );
	box3 = Bodies.rectangle(300, 600, 20, 200 , {isStatic:true} );
